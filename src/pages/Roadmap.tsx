...
const phases = [
  {
    ...
    status: "completed",
    progress: 100,
    features: ["UEFI bootloader", "Basic kernel", "Memory management", "Interrupt handling"],
  },
  {
    phase: "Phase 2",
    title: "Core Systems",
    status: "completed",
    progress: 100,
    features: ["Process scheduler", "File system", "Device drivers", "System calls"],
  },
  {
    phase: "Phase 3",
    ...
    status: "in-progress",
    progress: 75,
    features: ["Fluent Design shell", "Window manager", "Desktop environment", "Settings app"],
  },
  {
    phase: "Phase 4",
    ...
    status: "in-progress",
    progress: 40,
    features: ["Windows API emulation", "Linux syscall support", "Android runtime", "GPU drivers"],
  },
  {
    phase: "Phase 5",
    title: "Networking",
    status: "planned",
    progress: 0,
    features: ["TCP/IP stack", "WiFi drivers", "Browser", "Package manager"],
  },
  {
    phase: "Phase 6",
    ...
    status: "planned",
    progress: 0,
    features: ["App store", "Cloud sync", "Multi-user", "Installation wizard"],
  },
];

const featureRoadmap = [
  { icon: Monitor, category: "Graphics", items: ["DirectX 12 support", "Vulkan API", "Multi-monitor", "HDR support"] },
  { icon: Wifi, category: "Connectivity", items: ["Ethernet drivers", "WiFi support", "Bluetooth", "USB 3.2 support"] },
  { icon: Shield, category: "Security", items: ["Secure boot", "App sandboxing", "Encryption", "Firewall"] },
  { icon: Gamepad2, category: "Gaming", items: ["Game mode", "Controller support", "Low latency audio", "Steam compatibility"] },
];
