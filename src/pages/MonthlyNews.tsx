...
const monthlyNewsData: Record<string, MonthData> = {
  "february-2026": {
    month: "February",
    year: "2026",
    summary: "Alpha Build 1.200 shipped with filesystem integration, 640×480 mode, File Explorer, Settings overhaul, and 30 stability fixes. Major subsystem TODOs completed.",
    highlights: [
      ...
      "Resizable windows, cursor smoothing, and mouse-wheel scrolling",
      ...
      "Removed Roadmap and Bug Tracking pages from website navigation",
