...
const monthlyNewsData: Record<string, MonthData> = {
  "february-2026": {
    month: "February",
    year: "2026",
    summary: "Alpha Build 1.300 shipped with .EXE app framework, Windows 7-inspired theme, custom wallpaper, expanded Settings, and taskbar date display. Build 1.200 added filesystem integration and 30 fixes.",
    highlights: [
      "Build 1.300 released with .EXE app framework and Windows 7-style theme",
      "Custom wallpaper from PNG integrated as live desktop background",
      "Settings expanded to 12 GamerOS-style categories with markdown changelog viewer",
      "Taskbar now shows both time and date (HH:MM DD/MM/YYYY)",
      "Build 1.200 released with 30 fixes and 15+ new features",
      "Storage-backed filesystem with File Explorer and Settings app",
      "VGA 640×480 mode 12h with full runtime register programming",
      "Core subsystem TODOs completed: font API, RTC date, security, process isolation",
    ...
    items: [
      {
        ...
        type: "Commit",
        description: "New .EXE app framework, Windows 7-inspired theme, custom wallpaper, expanded Settings with markdown viewer, taskbar date display. Build bumped to 1.300.",
        commitCode: "e44244d",
      ...
      },
      {
        ...
        date: "February 17, 2026",
        type: "Announcement",
        description: "Comprehensive walkthrough of .EXE app architecture, Windows 7 shell theme, custom wallpaper, Settings categories, and 6 stability fixes.",
        commitUrl: "/news/build-1300",
      },
      {
        title: "feat(changelog, walkthrough): enhance changelog and complete core TODOs across subsystems",
        date: "February 15, 2026",
        type: "Commit",
        description: "Font size API, RTC date API, window manager resize/focus/z-order, security subsystem, user-mode process isolation, GUI input handling, freestanding sprintf. Build bumped to 1.200.",
        commitCode: "f62d110",
      ...
      },
      {
        ...
        date: "February 15, 2026",
        type: "Announcement",
        description: "Comprehensive walkthrough of 30 fixes across filesystem, graphics, input, desktop shell, and core subsystem APIs.",
        commitUrl: "/news/build-1200",
      },
      {
